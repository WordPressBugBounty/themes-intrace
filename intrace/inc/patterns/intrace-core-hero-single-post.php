...
<div class="wp-block-group" style="padding-top:100px;padding-bottom:200px"><!-- wp:post-title {"textAlign":"center","style":{"typography":{"fontSize":"42px","lineHeight":"1","fontStyle":"normal","fontWeight":"700","textTransform":"uppercase","letterSpacing":"0.1em"}},"textColor":"white","fontFamily":"lato"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->',
	'is_sync' => false,
