...
<div class="wp-block-group" style="padding-top:100px;padding-bottom:200px"><!-- wp:query-title {"type":"search","textAlign":"center","style":{"typography":{"lineHeight":"1.1","fontStyle":"normal","fontWeight":"700","letterSpacing":"0.1em","textTransform":"uppercase"}},"fontSize":"heading-4","fontFamily":"lato"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->',
	'is_sync' => false,
