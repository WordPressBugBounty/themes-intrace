...
<div class="wp-block-group" style="padding-top:100px;padding-bottom:200px"><!-- wp:query-title {"type":"archive","textAlign":"center","level":2,"style":{"typography":{"fontSize":"42px","lineHeight":"1","fontStyle":"normal","fontWeight":"700","letterSpacing":"0.1em","textTransform":"uppercase"}},"textColor":"white","fontFamily":"lato"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->',
	'is_sync' => false,
